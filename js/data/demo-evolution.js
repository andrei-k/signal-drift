export const ARTICLE_SECTIONS = [
  {
    ...
    author: 'Andrei Kalamkarov',
  },
  {
    type: 'prose',
    html: `<p>Every year, Concordia University's Library hosts <a href="https://sites.events.concordia.ca/sites/concordia/en/digital-skills-share-2026" target="_blank"><strong>Digital Skill-Share Days</strong></a>, a two-day collaborative learning event where staff and faculty share digital skills with each other. It started in 2020 during the pandemic to meet the demand for digital upskilling, and it's been running ever since.</p>
<p>The 2026 edition featured a <strong>Lightning Round on Artificial Intelligence and Data</strong> on Tuesday, February 24. Four speakers, five minutes each to present plus five minutes for Q&amp;A, covering everything from the environmental cost of AI to how data work is changing.</p>
<p>I manage web and mobile technology at Concordia, and the title I'd committed to was: <strong>"The Multi-Model Approach: Getting Better Answers by Switching Perspectives."</strong> My thesis was straightforward: using multiple AI models intentionally, switching between them based on what each does best, produces better results than sticking with just one. But saying that on a stage doesn't prove much. I needed to <em>show</em> it with a real project.</p>
<p>I started where most projects start: a messy brain dump. Six rough ideas in a markdown file: a site builder, a Kindle article aggregator, a Montreal events tool, a Kindle highlights re-surfacer, a project management dashboard, and a gym workout analyzer. None of them felt obviously right for a five-minute talk. So I did the only logical thing for someone preparing a presentation about AI: I asked AI for help. Four of them, actually.</p>
