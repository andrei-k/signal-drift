...
const GPT52_DESC_SAMPLE2 = `A square, full-color outdoor photograph shows a busy urban street intersection viewed from an elevated position, looking straight down the street and slightly downward from what appears to be an upper-floor window or balcony. The scene is framed vertically with the street running from the bottom center into the distance toward the middle of the image, and a large church with two very tall green spires rising in the background near the center-right. The sky fills the upper half of the image and is pale, clear, and softly lit, with a very light gradient from off-white to faint blue. The overall lighting looks like late afternoon or early evening, with gentle, even daylight and no harsh shadows.

In the far background, the church dominates the skyline. It has two narrow, pointed spires covered in green oxidized copper, each topped with a finial/cross-like ornament. The right spire is taller and closer to the top edge; the left spire is slightly shorter and positioned just left of it. Below the spires is a stone church structure with gray and beige masonry, arched openings, and vertical decorative details. Parts of the lower church are partially obscured by trees and buildings in front.

The midground is packed with people and a row of temporary canopy tents set up along the right side of the street. The tents are mostly blue, with a few white and one purple tent farther back. Small string lights appear along the tent edges, creating a dotted warm glow. White logos or text are printed on some tent valances, but most are too small or unclear to read. The street is crowded with many dozens of people standing, walking, and gathering in groups. Clothing colors vary widely (black, blue, white, pink, gray, tan), and individual facial details are too small to distinguish for most people due to distance.

The foreground shows a four-way intersection with white zebra crosswalk stripes and wet dark asphalt. There are puddles and reflective patches on the road surface, especially on the right half of the intersection, reflecting some light and nearby shapes. Near the bottom center-right is a red octagonal stop sign with white border and the French word "ARRÊT" in white letters. Below it is a smaller rectangular sign with red and white sections and small symbols that are unclear. Just behind and above the stop sign is a dark street name sign reading "Drolet" in white letters, mounted on a pole. White road markings are visible on the asphalt, including bike-lane-like symbols and lane lines, though some markings are partially obscured by water and people.

At the bottom left foreground, several pedestrians are crossing or standing near the crosswalk. A small group includes adults and children; one child appears to be holding a blue balloon. A person is pushing a stroller with a child seated inside near the lower center-left. Another person in dark clothing stands near a cylindrical blue trash can in the center-left foreground. People are also gathered along the sidewalks on both sides.

On the left side of the image, a tall brick wall occupies the full left edge from top to bottom, very close to the camera, with reddish-brown bricks and mortar lines clearly visible. Near the lower-left corner, part of a sign or billboard is visible with large yellow and red areas and partial letters, but the text is cut off and unreadable. A curved black metal element (possibly a railing or lamp arm) is visible in front of this lower-left area. Slightly farther into the scene on the left stands a white brick building with brown trim around windows and roofline. A small round or oval storefront sign hangs from this building, but the text/logo is unclear. A utility pole with attached hardware stands near the left side of the street, with multiple overhead wires extending horizontally across the image.

On the right side, a row of two- to three-story red brick buildings lines the street. These buildings have white trim around windows and doors, some small balconies with dark railings, and green-and-white striped awnings over parts of the ground-floor storefronts. Some interior spaces are visible through large windows on the ground floor, with warm indoor lighting and furniture or merchandise inside, but details are indistinct. A second utility pole stands near the right side of the intersection, also supporting many overhead wires that crisscross the upper-middle portion of the image. Several street signs are attached to poles on the right, including a bright yellow pedestrian crossing sign and smaller white/yellow signs beneath it; most small text is too small to read.

Trees with green foliage line both sides of the street and partially block the lower portion of the church. The leaves add dense green shapes through the middle of the image, especially center-left and center. The color palette is dominated by red-brown brick, gray-black asphalt, pale sky, green trees, and the striking turquoise-green church spires, with the blue tent roofs and red stop sign standing out strongly.

The composition is dense and layered: close brick wall on the left foreground, intersection and pedestrians in the lower foreground, crowded street market-like setup in the midground, and the twin-spired church in the background centered above the street. The image already appears square, and the visible framing includes the full stop sign in the lower center-right, the left brick wall edge, the right row of buildings, and both church spires reaching near the top edge.`;
